  ...
  methods:{
    ...
    async rechazarRepresentante(){
      try {  
        ...
        let {data} = await this.requestApi('rechazar_revision_representante_legal_bo', put,"PUT");
        return data;        
      } catch (error) {
    ...
    async rechazarCuenta(){
      try {     
        ...
        put.id_usuario = this.idUsuario;
        put.observacion_rechazo = this.rechazo;
        let {data} = await this.requestApi('rechazar_revision_cuenta_bancaria_bo', put,"PUT");
        return data;        
      } catch (error) {
        throw new Error(error);
      } finally {
