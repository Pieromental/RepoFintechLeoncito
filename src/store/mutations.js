...
const mutations = {
  ...
  CAMBIAR_COMPANIA_SELECCIONADA(state, compania) {
    state.companiaSeleccionada = compania;
  },

  CAMBIAR_LOGO_COMPANIA_SELECCIONADA(state, data) {
    state.logoCompaniaSeleccionada = data.logo;
    state.logoCompaniaIconoSeleccionada = data.logoIcono;
  },
  CAMBIAR_MENU_PERMISOS(state, permisos) {
    state.permisos = permisos;
  },
  CAMBIAR_MENU(state, menu) {
    state.menu = menu;
  },
  TIEMPO_MENSAJE(state, tiempo) {
    state.tiempo = tiempo;
  },
  COPIAR_SERIE(state, copiarSerie) {
    state.copiarSerie = copiarSerie;
  },
  CAMBIAR_ALTA_APLICACION(state, paltaaplicacion) {
    state.paltaaplicacion = paltaaplicacion;
  }
};
